...
def error_velocity(x, erro_x):

	erro_v = np.std(x)/np.sqrt(len(x))
	return erro_v

Erro_dopp=error_doppler(p1,Erro_p1)

Erro_vel=error_velocity(dopp, Erro_dopp)
print(Erro_vel)
